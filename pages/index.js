                  ...
                  {[
                    {
                      ...
                      text: "Artist and release context.",
                    },
                    {
                      title: "Sonic Pressure",
                      text: "Genre, BPM and emotional charge.",
                    },
                    {
                      title: "Material Language",
                      text: "Texture, light, surface and atmosphere.",
                    },
                    {
                      title: "Director Grammar",
                      text: "Camera behavior and visual discipline.",
                    },
                    {
                      title: "World Logic",
                      text: "Architecture, culture and cinematic universe.",
                    },
                    {
                      title: "Release Objective",
                      text: "The final purpose FrameLab builds toward.",
                    },
                  ].map((item) => (
                    <div
                      key={item.title}
