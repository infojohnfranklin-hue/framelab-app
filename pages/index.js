...
export default function Home() {
  ...
  const creativeDirectorSummary = (() => {
    if (!artist || !track || !genre || !bpm || !mood || !style || !directorMode || !styleDNA || !era || !reelPurpose) {
      return "Complete the creative inputs to unlock the Creative Director Summary.";
    }

    return `${artist} — ${track} should be treated as a complete creative world, not a single reel idea. The identity, sonic pressure, material behavior, camera grammar, world rules and release objective should work as one connected direction: ${identityEngineIntelligence.replace("Creative Assessment: ", "")} ${sonicPressureIntelligence.replace("Creative Assessment: ", "")} ${materialLanguageIntelligence.replace("Creative Assessment: ", "")} ${directorGrammarIntelligence.replace("Creative Assessment: ", "")} ${worldLogicIntelligence.replace("Creative Assessment: ", "")} ${releaseObjectiveIntelligence.replace("Creative Assessment: ", "")}`;
  })();
              ...
              >
                  ...
                  {[
                    ...
                    return (
                      <div
                        key={item.title}
                        style={{
                          padding: isPrimaryBriefingEngine ? "18px 18px" : "15px 15px",
                          borderRadius: "16px",
                          ...
                          boxShadow: isPrimaryBriefingEngine
                            ? "0 18px 55px rgba(88,28,135,0.22)"
                            : "none",
                        }}
                      >
                      <div
                ...
                <div
                  style={{
                    ...
                    padding: "22px",
                    borderRadius: "18px",
                    background: "linear-gradient(135deg, rgba(139,92,246,0.18), rgba(15,23,42,0.65))",
                    border: "1px solid rgba(196,181,253,0.20)",
                    boxShadow: "0 18px 60px rgba(88,28,135,0.20)",
                  }}
                >
                  <div
                    style={{
